...
```
###### you can then refer to the _Greeting_ class as _TestHello.Greeting_ in programs. If another developer also creates a _Greeting_ class in a different namespace, such as _NewNamespace_
